 ...
 */
var TextStream = function(filename, unicode) {
    // Default properties
...
TextStream.prototype.Read = function(characters) {
    ...
    return this._contents.length > characters ? this._contents.substr(0, characters) : this._contents;
};
...
TextStream.prototype.Skip = function(characters) {
    ...
    return this._contents.substr(characters);
};
