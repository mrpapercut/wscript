class bdatuner_dvbtlocator2_1 {
    constructor() {
        ...
        this.LPInnerFEC = undefined;

        // BinaryConvolutionCodeRate LPInnerFECRate () {get} {set}
        this.LPInnerFECRate = undefined;
        ...
        this.OtherFrequencyInUse = undefined;
        ...
        // int PhysicalLayerPipeId () {get} {set}
        this.PhysicalLayerPipeId = undefined;
...
module.exports = bdatuner_dvbtlocator2_1;
