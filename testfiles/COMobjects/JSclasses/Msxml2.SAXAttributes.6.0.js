class msxml2_saxattributes_6_0 {
    constructor() {
    }
    ...
    // void addAttributeFromIndex (Variant, int)
    addAttributeFromIndex(Variant, int) {
...
module.exports = msxml2_saxattributes_6_0;
