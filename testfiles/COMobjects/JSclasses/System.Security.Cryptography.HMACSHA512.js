class system_security_cryptography_hmacsha512 {
    constructor() {
        ...
        this.ProduceLegacyHmacValues = undefined;
    ...
    // byte[] ComputeHash(System.IO.Stream inputStream), byte[] ComputeHash(byte[] bu...
    ComputeHash() {
...
module.exports = system_security_cryptography_hmacsha512;
