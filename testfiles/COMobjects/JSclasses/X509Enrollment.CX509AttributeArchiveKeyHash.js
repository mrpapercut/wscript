class x509enrollment_cx509attributearchivekeyhash {
    constructor() {
    ...
    // void InitializeEncodeFromEncryptedKeyBlob (EncodingType, ...
...
module.exports = x509enrollment_cx509attributearchivekeyhash;
