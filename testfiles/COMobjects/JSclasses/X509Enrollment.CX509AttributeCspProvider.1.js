class x509enrollment_cx509attributecspprovider_1 {
    constructor() {
    ...
    // void InitializeEncode (X509KeySpec, string, EncodingType, string)
    InitializeEncode(X509KeySpec, string, EncodingType, string) {

    }

}

module.exports = x509enrollment_cx509attributecspprovider_1;
