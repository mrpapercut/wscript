class x509enrollment_cx509extensionenhancedkeyusage {
    constructor() {
        ...
        // IObjectIds EnhancedKeyUsage () {get}
        this.EnhancedKeyUsage = undefined;
    ...
    // void InitializeEncode (IObjectIds)
    InitializeEncode(IObjectIds) {

    }

}

module.exports = x509enrollment_cx509extensionenhancedkeyusage;
