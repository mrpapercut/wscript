class x509enrollment_cx509extensionkeyusage {
    constructor() {
    ...
    // void InitializeEncode (X509KeyUsageFlags)
    InitializeEncode(X509KeyUsageFlags) {

    }

}

module.exports = x509enrollment_cx509extensionkeyusage;
