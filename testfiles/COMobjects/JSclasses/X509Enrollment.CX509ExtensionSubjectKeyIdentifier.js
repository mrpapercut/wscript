class x509enrollment_cx509extensionsubjectkeyidentifier {
    constructor() {
        // string SubjectKeyIdentifier (EncodingType) {get}
    ...
    // void InitializeEncode (EncodingType, string)
    InitializeEncode(EncodingType, string) {

    }

}

module.exports = x509enrollment_cx509extensionsubjectkeyidentifier;
