class x509enrollment_cx509extensiontemplatename_1 {
    constructor() {
    ...
    // void InitializeEncode (string)
    InitializeEncode(string) {

    }

}

module.exports = x509enrollment_cx509extensiontemplatename_1;
