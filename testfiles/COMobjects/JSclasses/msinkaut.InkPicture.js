class msinkaut_inkpicture {
    constructor() {
        ...
        // bool InkEnabled () {get} {set}
        this.InkEnabled = undefined;
        ...
        // IPictureDisp Picture () {get} {set} {set by ref}
        ...
        // InkPictureSizeMode SizeMode () {get} {set}
        this.SizeMode = undefined;
...
module.exports = msinkaut_inkpicture;
